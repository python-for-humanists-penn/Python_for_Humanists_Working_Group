...
# load Image file
# img1 = Image.open(f'{ms_name}/0025_0000_web.jpg')  # 'image1.jpeg' should locate in current directory for this example
# b = io.BytesIO()
# img1.save(b, 'jpeg')
# b_image1 = b.getvalue()

# define Image file path in .epub
# image1_item = epub.EpubItem(uid='image_1', file_name=f'{ms_name}/0025_0000_web.jpg', media_type='image/jpeg', content=b_image1)

# add Image file
# book.add_item(image1_item)

# image1 = epub.EpubItem(uid='image1', file_name=f'{ms_name}/0025_0000_web.jpg', content=open(f'{ms_name}/0025_0000_web.jpg', 'rb').read(), media_type='image/jpg')
# image1.set_content(open(f'{ms_name}/0025_0000_web.jpg', 'rb').read())
...
# basic spine
book.spine = ['nav']  # required element
